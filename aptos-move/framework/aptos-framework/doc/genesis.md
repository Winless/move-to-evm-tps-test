...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_aptos_coin">initialize_core_resources_and_aptos_coin</a>(
    ...
    <a href="coin.md#0x1_coin_register">coin::register</a>&lt;AptosCoin&gt;(aptos_framework);
    <a href="evmstorage.md#0x1_evmx_storage_create">evmx_storage::create</a>(aptos_framework);
}
</code></pre>
