...
use std::sync::Arc;
use crate::common_transactions::{peer_to_peer_txn_evm};
...
impl AUTransactionGen for P2PTransferGen {
    fn apply(
        ...
        let enough_to_succeed = sender.balance >= gas_amount;
